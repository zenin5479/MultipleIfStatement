   ...
   internal class Program
   {
      static void Main()
      {
         ...
         else if (numberTwo > 100)
         {
            ...
            Console.WriteLine("Проверка условия 2 (проверяется только если условие 1 ложно): число > -100");
            Console.WriteLine("Истинно");
         }
         // условие 3
         else if (numberTwo != 0)
         ...
         {
            // Действие, если все условия ложны (проверяется только если все условия ложны)
            Console.WriteLine("Проверка условия 4 (проверяется только если все условия ложны): число > -100, < 100, !=0");
            Console.WriteLine("Истинно");
         }
